...
class Control:
    def __init__(self,configurationfile):
        ...
        self.configData = ConfigLoader.configuration_loader(configurationfile)
        self.jevis = JEVis(self.configData.jevisUser,self.configData.jevisPW,self.configData.webservice)


    def configuration_loader(self,configurationfile):
    ...
    def modelidentification(self,zonename, configurationfile, fromD, toD, calibration='true', set_equalHeaterParameter='false'):
        ...
        if zonename == 'all':
            ...
            for j in range(len(self.configData.systems)):
                ...
                for n in range(len(self.configData.systems[j])):
                    ...
                    if calibration=='true':
                        ...
                        self.identification_with_calibration(self.configData.modelfile, self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.objectIds.heatersRead[i], np.size(self.configData.objectIds.heatersRead[i]),
                        ...
                        # Starting the identification-Function given above
                        self.identification(self.configData.modelfile, self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.objectIds.heatersRead[i], np.size(self.configData.objectIds.heatersRead[i]),
                                   self.configData.objectIds.disturbancesRead[i],
                                   self.configData.objectIds.temperaturesRead[i], self.configData.objectIds.fullloadRead[j], self.configData.objectIds.energyRead[i], fromD, toD, '00', '00', self.configData.jevisUser,
                                   self.configData.jevisPW, self.configData.webservice, set_equalHeaterParameter)
                    else:
            ...
            for n in range(len(self.configData.systems[j])):
                ...
                if calibration == 'true':
                    # Starting the identification-Function given above
                    self.identification_with_calibration(self.configData.modelfile, self.configData.objectIds.weekendOperationRead[index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.objectIds.heatersRead[index[j][n]],
                    ...
                    # Starting the identification-Function given above
                    self.identification(self.configData.modelfile, self.configData.objectIds.weekendOperationRead[index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.objectIds.heatersRead[index[j][n]], np.size(self.configData.objectIds.heatersRead[index[j][n]]),
                                    self.configData.objectIds.disturbancesRead[index[j][n]],
        ...
        if zonename == 'all':
            ...
            for j in range(np.size(self.configData.systems)):
                ...
                for n in range(np.size(self.configData.systems[j])):
                    ...
                    if calibration=='true':
                        ...
                        self.Validation_with_calibration(self.configData.objectIds.weekendOperationRead[i],self.configData.heaterdata, self.configData.zonenames[i],self.configData.objectIds.heatersRead[i], np.size(self.configData.objectIds.heatersRead[i]), self.configData.objectIds.disturbancesRead[i],
                        ...
                        # Starting the Plotting-Function given above
                        self.Validation(self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.ObjectIDs[0][i], np.size(self.configData.ObjectIDs[0][i]), self.configData.ObjectIDs[2][i],
                               self.configData.objectIds.temperaturesRead[i],
            ...
            for n in range(len(self.configData.systems[j])):
                ...
                if calibration == 'true':
                    ...
                    # Starting the Plotting-Function given above
                    self.Validation_with_calibration(self.configData.ObjectIDs[7][index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.objectIds_2[0][index[j][n]], np.size(self.configData.objectIds_2[0][index[j][n]]),
                    ...
                    # Starting the Plotting-Function given above
                    self.Validation(self.configData.objectIds_2[7][index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.objectIds_2[0][index[j][n]], np.size(self.configData.objectIds_2[0][index[j][n]]), self.configData.objectIds_2[2][index[j][n]],
                           self.configData.objectIds_2[1][index[j][n]],
                           self.configData.objectIds_2[3][j], self.configData.objectIds_2[4][index[j][n]], fromDv, toDv, '00',
                           '00', 0, Params, self.configData.jevisUser, self.configData.jevisPW, self.configData.webservice)
                else:
            ...
            if calibration=='true':
                ...
                Params = r.load_model_with_calibration(self.configData.modelfile, self.configData.zonenames[i])
                # Starting the Plotting-Function given above
                self.Validation_with_calibration(self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i],self.configData.objectIds.heatersRead[i], np.size(self.configData.objectIds.heatersRead[i]), self.configData.objectIds.disturbancesRead[i], self.configData.objectIds.temperaturesRead[i],
                ...
                Params = r.load_model(self.configData.modelfile, self.configData.zonenames[i])
                # Starting the Plotting-Function given above
                self.Validation(self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.objectIds.heatersRead[i], np.size(self.configData.objectIds.heatersRead[i]), self.configData.objectIds.disturbancesRead[i], self.configData.objectIds.temperaturesRead[i],
...
# Control-Functions: Call Functions for the Regulation-Functions:
    ...
    def Controlfunction(self,systemname,configurationfile,TimeID,calibration='true'):
        ...
        if systemname == 'all':
            ...
            for j in range(np.size(self.configData.systems)):
                ...
                for n in range(len(self.configData.systems[j])):
                    ...
                    if calibration=='true':
                        ...
                        [fullload[n], heaters[n]] = self.Regulation_calibration(self.configData.modelfile, TimeID, self.configData.objectIds.weekendOperationRead[index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.weightfactor[index[j][n]], self.configData.objectIds.disturbancesRead[index[j][n]],
                        ...
                        # Starting Regulation-Function given above, with the given fullload-demand
                        [fullload[n], heaters[n]] = self.Regulation(self.configData.modelfile, TimeID, self.configData.objectIds.weekendOperationRead[index[j][n]], self.configData.heaterdata, self.configData.zonenames[index[j][n]], self.configData.weightfactor[index[j][n]], self.configData.objectIds.disturbancesRead[index[j][n]],
                                                           self.configData.objectIds.temperaturesRead[index[j][n]], self.configData.objectIds.heatersRead[index[j][n]], self.configData.objectIds.fullloadRead[j], self.configData.objectIds.energyRead[index[j][n]],
            ...
            if calibration=='true':
                # Starting Regulation-Function given above
                [fullload, heaters] = self.Regulation_calibration(self.configData.modelfile, TimeID, self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.weightfactor[i], self.configData.objectIds.disturbancesRead[i],
                ...
                # Starting Regulation-Function given above
                [fullload, heaters] = self.Regulation(self.configData.modelfile, TimeID, self.configData.objectIds.weekendOperationRead[i], self.configData.heaterdata, self.configData.zonenames[i], self.configData.weightfactor[i], self.configData.objectIds.disturbancesRead[i],
                                             self.configData.objectIds.temperaturesRead[i], self.configData.objectIds.heatersRead[i], self.configData.objectIds.fullloadRead[j], self.configData.objectIds.energyRead[i],
